public class Mercado {
	public static void main (String[] args) {
		...
		int contador, N_mercadorias, quantidade_total;
		String nome_merc;
		
			System.out.println ("Informe o numero de mercadorias diferentes vendidas pelo mercado:");
			N_mercadorias = Integer.parseInt (System.console().readLine());
		
			for (contador = 1,fat_mens = 0; contador <= N_mercadorias; contador++) {
